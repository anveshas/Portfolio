...
const About = () => {
  return (
    <>
      ...
      <div className='mt-8'>
  {/* <p className='text-white-100 mb-4'>View my resume to learn more about my skills and experience.</p> */}
  <a
    href="https://drive.google.com/file/d/1nD6UP3js2YaDXSPkcOHLGQV_OHQDJrKh/view?usp=sharing" // Replace with your Google Drive link
